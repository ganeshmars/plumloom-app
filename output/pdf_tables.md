...
|Bob|2|5|6|7|
|Sue|3|8|4|7|
|Sam|[data relating to both columns in a single cell spanning both]|[data relating to both columns in a single cell spanning both]|[data relating to both columns in a single cell spanning both]|[data relating to both columns in a single cell spanning both]|
